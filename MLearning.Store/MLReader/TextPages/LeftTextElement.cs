...
namespace MLReader
{
    public sealed partial class LeftTextElement :  Grid , ISlideElement
    {

        public event ISlideElementSizeChangedEventHandler ISlideElementSizeChanged;

        public LeftTextElement()
        {
            init();
            SizeChanged += LeftTextElement_SizeChanged;
        }
        ...
        void init()
        {
            ...
            _contentblock = new TextBlock() { TextWrapping = Windows.UI.Xaml.TextWrapping.Wrap, FontSize = 33, FontWeight= Windows.UI.Text.FontWeights.Light };
